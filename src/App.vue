...
<script>
/* eslint-disable */
import Dropzone from "./components/UI_components/Dropzone";
import SingleUpload from "./components/UI_components/SingleUpload";
import MultiUpload from "./components/UI_components/MultipleUpload";
export default {
  name: "App",
  components: {
    Dropzone,
